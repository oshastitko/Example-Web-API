...
using WebApiExample.Core.DTO.RegisteredDevices;
...
[ApiController]
public class RegisteredDevicesController(IRegisteredDeviceService service) : ControllerBase
{

    /// <summary>
    /// Get registered device list based on search parameters
    /// </summary>
    ...
    [ProducesResponseType(typeof(PagingApi<RegisteredDeviceDto, SearchRegisteredDeviceDto>), StatusCodes.Status200OK)]
    public IActionResult List([FromQuery] SearchRegisteredDeviceDto searchModel)
    {
        var model = service.GetDevices(searchModel);

        PagingApi<RegisteredDeviceDto, SearchRegisteredDeviceDto> paging = new(model, searchModel)
        {
            Data = model.ToList(),
        };
    ...
    /// <summary>
    /// Link registered device to vendor
    /// </summary>
    ...
    /// <summary>
    /// Link array of registered devices to Vendor
    /// </summary>
    /// <param name="vendorId"></param>
    ...
    /// <summary>
    /// Unlink registered device from Vendor
    /// </summary>
    /// <param name="deviceId"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Unlink array of registered devices from Vendor
    /// </summary>
    /// <param name="deviceIds"></param>
    /// <returns></returns>
    /// <response code="204">Unlinked successfully</response>
    ...
    /// <summary>
    /// Set address of registered device as virtual
    /// </summary>
    /// <param name="deviceId"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Set addresses of array of registered devices as virtual
    /// </summary>
    /// <param name="deviceIds"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Set address of registered device as not virtual
    /// </summary>
    /// <param name="deviceId"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Set addresses of array of registered devices as not virtual
    /// </summary>
    /// <param name="deviceIds"></param>
    /// <returns></returns>
