...
public interface IRegisteredDeviceService
{
    ...
    /// <returns></returns>
    IPagedList<RegisteredDeviceDto> GetDevices(SearchRegisteredDeviceDto searchModel);
    ...
    IPagedList<RegisteredDeviceHistoryItemDto> GetDeviceHistory(int deviceId);
